...
fn store_error(error: crate::config::profile_store::ProfileStoreError) -> std::io::Error {
    match error {
        crate::config::profile_store::ProfileStoreError::Io(io) => io,
...
mod ownership_and_error_kind_tests {
    ...
    fn store_error_preserves_the_underlying_io_kind() {
        let denied = crate::config::profile_store::ProfileStoreError::Io(std::io::Error::new(
        ...
        let not_found = crate::config::profile_store::ProfileStoreError::Io(std::io::Error::new(
