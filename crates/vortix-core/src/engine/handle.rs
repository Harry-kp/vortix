...
use crate::engine::fsm::Engine;
use crate::engine::input::{Input, UserCommand};
use crate::engine::state::Connection;
use crate::journal::Journal;
use crate::ports::tunnel::Tunnel;
...
impl LocalHandle {
    ...
    #[must_use]
    pub fn for_test() -> Self {
        use crate::ports::tunnel::mock::MockTunnel;
        use crate::profile::{Profile, ProfileId, ProtocolKind};
        use std::path::PathBuf;

        let journal = Journal::open(crate::journal::JournalConfig {
            disk: false,
            ..Default::default()
        })
